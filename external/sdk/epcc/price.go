...
func (prices) Get(ctx *context.Context, client *Client, pricebookId string, priceId string) (*PriceData, ApiErrors) {
...
func (prices) GetAll(ctx *context.Context, client *Client, pricebookId string) (*PriceList, ApiErrors) {
...
func (prices) Create(ctx *context.Context, client *Client, pricebookId string, productPrice *Price) (*PriceData, ApiErrors) {
	priceData := PriceData{
		Data: *productPrice,
	}
...
func (prices) Delete(ctx *context.Context, client *Client, pricebookId string, priceId string) ApiErrors {
	path := fmt.Sprintf("/pcm/pricebooks/%s/prices/%s", pricebookId, priceId)
...
func (prices) Update(ctx *context.Context, client *Client, pricebookId string, priceId string, productPrice *Price) (*PriceData, ApiErrors) {
