		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr("epcc_oidc_profile.acc_test_profile", "callback_endpoint", regexp.MustCompile("^https")),
					resource.TestMatchResourceAttr("epcc_oidc_profile.acc_test_profile", "authorization_endpoint", regexp.MustCompile("^https")),
					resource.TestMatchResourceAttr("epcc_oidc_profile.acc_test_profile", "client_discovery_url", regexp.MustCompile("^https")),
