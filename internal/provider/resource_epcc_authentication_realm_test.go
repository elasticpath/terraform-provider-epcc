...
func TestAccResourceAuthenticationRealm(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr("epcc_authentication_realm.acc_test_realm", "duplicate_email_policy", regexp.MustCompile("allowed")),
					resource.TestMatchResourceAttr("epcc_authentication_realm.acc_test_realm", "origin_id", regexp.MustCompile("hello-world")),
