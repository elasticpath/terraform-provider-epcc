		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("epcc_promotion.acc_test_promotion", "schema.0.currencies.0.currency", "GBP"),
					...
					resource.TestCheckResourceAttr("epcc_promotion.acc_test_promotion", "max_discount_value.0.currency", "GBP"),
					...
					resource.TestCheckResourceAttr("epcc_promotion.acc_test_promotion", "min_cart_value.0.currency", "GBP"),
